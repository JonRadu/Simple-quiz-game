 ...
 */
public class Intrebare3 extends javax.swing.JFrame {
public String[] splitter;
 //ID id3 = new ID(3);
    /**
     * Creates new form Intrebare3
     */
    public Intrebare3() {
        initComponents();
...
int nr_intr=r_corect+r_gresit+1;
    ...
    private void jButton5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton5MouseClicked
       ...
       Intrebare4 intrebare4= new Intrebare4();
       intrebare4.setVisible(true);
       RaspunsCorect corect = new RaspunsCorect();
       corect.setVisible(true);
       corect.jLabel1.setText("Rapunsul" + " a)" +" a fost corect");
        this.dispose();
...
Intrebare1.counter_gresit++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Intrebare3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Intrebare3().setVisible(true);
