 ...
 */
public class Intrebare4 extends javax.swing.JFrame {
public String[] splitter;
int nr_gresite=3;
    /**
     * Creates new form Intrebare4
     */
    public Intrebare4() {
        initComponents();
...
int nr_intr=r_corect+r_gresit+1;
    ...
    private void jButton7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton7MouseClicked
       ...
       Intrebare1.counter_fisier++;
        Intrebare5 intrebare5= new Intrebare5();
        intrebare5.setVisible(true);
        RaspunsCorect corect = new RaspunsCorect();
       corect.setVisible(true);
       corect.jLabel1.setText("Rapunsul" + " c)" +" a fost corect");
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Intrebare4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Intrebare4().setVisible(true);
            }
        });
    }
